        ...
        <div className="h-96 pt-12 mt-40 bg-cover bg-center bg-no-repeat relative"
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 my-10">
                ...
                <button
                    ...
                    className="px-8 py-3 flex items-center gap-2 cursor-pointer transition-all duration-200 bg-gradient-to-r from-red-500 to-orange-500
                hover:from-red-600 hover:to-orange-600  rounded-full hover:text-white hover:bg-transparent mx-auto">
                    Sign Up Now
