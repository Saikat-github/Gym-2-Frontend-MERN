...
const Features = () => {
  return (
    <div className="py-24 mt-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          <h2 className="text-4xl sm:text-6xl font-bold">Why Choose Minimalist Gym?</h2>
          <p className="mt-4 text-sm">We provide everything you need to achieve your fitness goals</p>
        </div>
